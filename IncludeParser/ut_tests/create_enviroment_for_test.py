...
class EnvTestClass:
    ...
    def get_exp_test_path(self):
        return self._exp_test_path
    ...
    def _create_empty_header_files(self, path, file_list):
        ...
        for list_item in file_list:
            ...
            f = open(path_str, "w")
            f.close()
            self._exp_test_path.append(path_str)
    ...
    def _create_Module_1_for_test(self):
        header_path_str = self._test_path + MODULE_FOR_TEST + "\\module_1.hpp"
        source_path_str = self._test_path + MODULE_FOR_TEST + "\\module_1.cpp"
    ...
    def is_file_include_path_exists(self, include_path_item):
        if include_path_item in self._exp_test_path:
            return True
        else:
            return False
...
# o = EnvTestClass(os.path.dirname(os.path.abspath(__file__)))
# o.create_env_for_test()
# #print o.get_exp_test_path()
# print "HEADERS---------------------"
# for item in o.get_exp_test_path():
#     print item
